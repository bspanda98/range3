...
func (b *CheckpointAPI) registry(
	...
	contract, err := energi_abi.NewICheckpointRegistry(
		energi_params.Range_CheckpointRegistry, b.backend.(bind.ContractBackend))
	if err != nil {
		return nil, nil, err
	}
...
func (b *CheckpointAPI) checkpointInfo(num *big.Int) (interface{}, error) {
	registry, err := energi_abi.NewICheckpointRegistryCaller(
		energi_params.Range_CheckpointRegistry, b.backend.(bind.ContractCaller))
	if err != nil {
...
func (b *CheckpointAPI) CheckpointPropose(
	...
	registry, hashsig, err := b.registry(password, b.backend.ChainConfig().Range.CPPSigner)
	if err != nil {
		return
	}
