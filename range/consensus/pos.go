 ...
 */
func (e *Range) calcPoSDifficulty(
	chain ChainReader,
	time uint64,
	parent *types.Header,
	tt *timeTarget,
 ...
 * to start with.
 */
func (e *Range) lookupStakeWeight(
	chain ChainReader,
	now uint64,
	till *types.Header,
	addr common.Address,
...
func (e *Range) mine(
	...
	for _, a := range accounts {
		...
		if a == energi_params.Range_MigrationContract {
			migration_dpos = true
		}
	}
