...
import (
	...
	ch "range/core/gen3/swarm/chunk"
	"range/core/gen3/swarm/shed"
...
//
// # go test -benchmem -run=none range/core/gen3/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
