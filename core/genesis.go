...
import (
	...
	"range/core/gen3/common/hexutil"
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	case ghash == params.MainnetGenesisHash:
		return params.RangeMainnetChainConfig
	case ghash == params.TestnetGenesisHash:
		return params.RangeTestnetChainConfig
	default:
...
func (g *Genesis) ToBlock(db ethdb.Database) *types.Block {
	...
	if config := g.Config; config != nil {
		debug := false
		author := energi_params.Range_TreasuryV1
		gasLimit := uint64(100000000)
		gp := new(GasPool)

		systemFaucet := energi_params.Range_SystemFaucet
...
func DefaultRangeMainnetGenesisBlock() *Genesis {
	return &Genesis{
		Config:     params.RangeMainnetChainConfig,
		...
		Xfers:      DeployRangeGovernance(params.RangeMainnetChainConfig),
	}
}

func DefaultRangeTestnetGenesisBlock() *Genesis {
	...
	return &Genesis{
		...
		Difficulty: big.NewInt(0xFFFF),
		Alloc:      DefaultPrealloc(),
		Xfers:      DeployRangeGovernance(params.RangeTestnetChainConfig),
	}
}

// DeveloperRangeGenesisBlock scans the custom genesis block from the provided
// file path.
func DeveloperRangeGenesisBlock(customGenesisPath string) (*Genesis, error) {
	...
	genesis.Xfers = append(genesis.Xfers, DeployRangeGovernance(genesis.Config)...)
	return genesis, nil
}
...
func DeployRangeGovernance(config *params.ChainConfig) GenesisXfers {
	...
	deployRangeContract(
		&xfers,
		energi_params.Range_BlockRewardV1,
		nil,
		energi_abi.BlockRewardV1ABI,
		energi_abi.BlockRewardV1Bin,
		energi_params.Range_BlockReward,
		[4]common.Address{
			energi_params.Range_StakerReward,
			energi_params.Range_BackboneReward,
			energi_params.Range_Treasury,
			energi_params.Range_MasternodeRegistry,
		},
	)
	deployRangeContract(
		&xfers,
		energi_params.Range_TreasuryV1,
		nil,
	...
	deployRangeContract(
		&xfers,
		energi_params.Range_StakerRewardV1,
		nil,
	...
	deployRangeContract(
		&xfers,
		energi_params.Range_BackboneRewardV1,
		nil,
		energi_abi.BackboneRewardV1ABI,
		energi_abi.BackboneRewardV1Bin,
		energi_params.Range_BackboneReward,
		config.Range.BackboneAddress,
	)
	if ver > 1 {
		deployRangeContract(
			&xfers,
			energi_params.Range_SporkRegistryV1,
			nil,
			energi_abi.SporkRegistryV2ABI,
			energi_abi.SporkRegistryV2Bin,
			energi_params.Range_SporkRegistry,
			energi_params.Range_MasternodeRegistry,
			config.Range.CPPSigner,
		)
		deployRangeContract(
			&xfers,
			energi_params.Range_CheckpointRegistryV1,
			nil,
			energi_abi.CheckpointRegistryV2ABI,
			energi_abi.CheckpointRegistryV2Bin,
			energi_params.Range_CheckpointRegistry,
			energi_params.Range_MasternodeRegistry,
			config.Range.CPPSigner,
		)
		deployRangeContract(
			&xfers,
			energi_params.Range_MasternodeTokenV1,
			nil,
		...
		deployRangeContract(
			&xfers,
			energi_params.Range_MasternodeRegistryV1,
			nil,
		...
		panic("Range Genesis V1 is not supported anymore")
	}
	deployRangeContract(
		&xfers,
		energi_params.Range_BlacklistRegistryV1,
		nil,
		...
		energi_params.Range_CompensationFundV1,
		config.Range.EBISigner,
	)
	deployRangeContract(
		&xfers,
		energi_params.Range_CompensationFundV1,
	...
	deployRangeContract(
		...
		energi_params.Range_BlacklistRegistry,
		config.ChainID,
		config.Range.MigrationSigner,
	)
	deployRangeContract(
		&xfers,
		energi_params.Range_Blacklist,
		nil,
	...
	deployRangeContract(
		&xfers,
		energi_params.Range_MasternodeList,
		nil,
		energi_abi.DummyAccountABI,
		energi_abi.DummyAccountBin,
	)
	...
	proxies := map[common.Address]common.Address{
		energi_params.Range_BlockReward:        energi_params.Range_BlockRewardV1,
		energi_params.Range_Treasury:           energi_params.Range_TreasuryV1,
		energi_params.Range_MasternodeRegistry: energi_params.Range_MasternodeRegistryV1,
		energi_params.Range_StakerReward:       energi_params.Range_StakerRewardV1,
		energi_params.Range_BackboneReward:     energi_params.Range_BackboneRewardV1,
		energi_params.Range_SporkRegistry:      energi_params.Range_SporkRegistryV1,
		energi_params.Range_CheckpointRegistry: energi_params.Range_CheckpointRegistryV1,
		energi_params.Range_BlacklistRegistry:  energi_params.Range_BlacklistRegistryV1,
		energi_params.Range_MasternodeToken:    energi_params.Range_MasternodeTokenV1,
	}
