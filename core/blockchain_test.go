...
func TestChainTxReorgs(t *testing.T) {
	var (
		...
		gspec   = &Genesis{
			...
			GasLimit: 40000000,
			Alloc: GenesisAlloc{
				addr1: {Balance: big.NewInt(10000000)},
				addr2: {Balance: big.NewInt(10000000)},
				addr3: {Balance: big.NewInt(10000000)},
			},
		}
...
//
// https://range/core/gen3/pull/15941
...
//
// Details at:
//  - https://range/core/gen3/issues/18977
//  - https://range/core/gen3/pull/18988
