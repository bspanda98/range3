...
// Create creates a new contract using code as deployment code.
func (evm *EVM) CreateGenesis(caller ContractRef, contractAddr common.Address, code []byte, gas uint64, value *big.Int) (ret []byte, _ common.Address, leftOverGas uint64, err error) {
	return evm.create(caller, &codeAndHash{code: code}, gas, value, contractAddr)
}
