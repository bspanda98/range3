...
var (
	RangeMainnetChainConfig = &ChainConfig{
	...
	RangeTestnetChainConfig = &ChainConfig{
...
type ChainConfig struct {
	...
	Range *RangeConfig `json:"energi,omitempty"`
...
// RangeConfig is the consensus engine config for proof-of-stake based sealing.
...
// String implements the stringer interface, returning the consensus engine details.
func (*RangeConfig) String() string {
	return "energi"
}
