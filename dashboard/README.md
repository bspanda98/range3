## Range Core Dashboard

The dashboard is a data visualizer integrated into range3, intended to collect and visualize useful information of an Range node. It consists of two parts:
...
```
$ range3 --dashboard --vmodule=dashboard=5
