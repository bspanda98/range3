...
# 1. install range3 for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for range3
# 5. create range3, attach and uninstall start menu entries
...
!define GROUPNAME "Range"
!define APPNAME "Range Gen 3"
!define DESCRIPTION "Official Go implementation of the Range Gen 3 protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since range3 is installed global
