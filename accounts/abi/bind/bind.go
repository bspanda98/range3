...
// https://range/core/gen3/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
...
func Bind(types []string, abis []string, bytecodes []string, runtimecodes []string, pkg string, lang Lang) (string, error) {
	...
	for i := 0; i < len(types); i++ {
		...
		contracts[types[i]] = &tmplContract{
			...
			RuntimeBin:  strings.TrimSpace(runtimecodes[i]),
