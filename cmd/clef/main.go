...
import (
	...
	"range/core/gen3/rpc"
	"range/core/gen3/signer/core"
	"range/core/gen3/signer/rules"
	"range/core/gen3/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Range account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func DefaultConfigDir() string {
	...
	if home != "" {
		if runtime.GOOS == "darwin" {
			return filepath.Join(home, "Library", "RangeSigner")
		} else if runtime.GOOS == "windows" {
			return filepath.Join(home, "AppData", "Roaming", "RangeSigner")
		} else {
