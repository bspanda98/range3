...
const (
	clientIdentifier = "range3" // Client identifier to advertise over the network
)
...
var (
	...
	app = utils.NewApp(gitCommit, "the Range Core command line interface")
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	if ctx.GlobalBool(utils.MiningEnabledFlag.Name) ||
		...
		if err := stack.Service(&ethereum); err != nil {
			utils.Fatalf("Range service not running: %v", err)
		}
