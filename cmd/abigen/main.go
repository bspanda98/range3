...
import (
	...
	"range/core/gen3/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Range contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the Range contract bytecode (generate deploy method)")
	runFlag = flag.String("runbin", "", "Path to the Range contract runtimecode (generate runtime method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Range contract Solidity source to build and bind")
