...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "range3.ipc", false, filepath.Join(os.TempDir(), "range3.ipc")},
		{"data", "range3.ipc", false, "data/range3.ipc"},
		{"data", "./range3.ipc", false, "./range3.ipc"},
		{"data", "/range3.ipc", false, "/range3.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "range3.ipc", true, `\\.\pipe\range3.ipc`},
		{"data", "range3.ipc", true, `\\.\pipe\range3.ipc`},
		{"data", `\\.\pipe\range3.ipc`, true, `\\.\pipe\range3.ipc`},
	}
